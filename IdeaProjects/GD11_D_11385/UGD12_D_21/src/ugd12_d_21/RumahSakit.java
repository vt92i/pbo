...
//    for (TenagaKesehatan tk : tenagaKesehatan) {
//      this.danaRumahSakit += tk.pendapatan;
//    }
  ...
  public void NotifyObserver(double jumlah) {
    for (TenagaKesehatan tenagaKesehatan : tenagaKesehatan) {
      tenagaKesehatan.Update(jumlah);
    }
  }
...
//    this.danaRumahSakit += dokter.pendapatan;
  }
