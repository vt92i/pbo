...
public class TGS4_D_21 {
  ...
  public static void main(String[] args) throws IOException {
    ...
    while (counter < totalProduk) {
      ...
      switch (jenis) {
        case "televisi":
          if (tv[tv.length - 1] != null) {
            System.err.println("[ERROR] Maksimal 2 televisi.");
          }
        ...
        case "smartphone":
          if (sp[sp.length - 1] != null) {
            System.err.println("[ERROR] Maksimal 2 smartphone.");
          }
          ...
          break;
        case "laptop":
          if (lp[lp.length - 1] != null) {
            System.err.println("[ERROR] Maksimal 2 laptop.");
          }
        ...
        case "smarttv":
          if (stv == null) {
            ...
            System.err.println("[ERROR] Maksimal 1 smarttv.");
          }
          break;
        case "android":
          if (ad == null) {
            ...
            System.err.println("[ERROR] Maksimal 1 android.");
          }
          break;
        case "laptopgaming":
          if (lg == null) {
            ...
            System.err.println("[ERROR] Maksimal 1 laptop gaming.");
          }
          break;
        default:
